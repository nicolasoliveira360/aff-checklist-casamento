  ...
  return (
    <section className="bg-white py-8 md:py-16">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-rose-900 mb-3 md:mb-4 max-w-[280px] sm:max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto leading-[1.2] md:leading-[1.15]">
